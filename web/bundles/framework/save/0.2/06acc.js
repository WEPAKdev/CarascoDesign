$(function() {
    ...
    tl
        ...
        //.to(path_gradient_word, , {strokeDashoffset: "724px", ease: Power0.easeNone})

        //A
        .to(path_gradient_word, 0.8, {strokeDashoffset: "25px", strokeDasharray: "620px 61px", ease: Power0.easeNone})
        .to(path_plain_word, 0.4, {strokeDashoffset: "-63px", strokeDasharray: "0px, 69px, 15px, 650px", ease: Power0.easeNone}, '-=0.5')

        .to(path_gradient_word, 0.6, {strokeDashoffset: "198px", strokeDasharray: "620px 175px", ease: Power0.easeNone})
        .to(path_plain_word, 0.6, {strokeDashoffset: "68px", strokeDasharray: "0px, 69, 67px, 650px", ease: Power0.easeNone}, "-=0.6")

        .to(path_gradient_word, 0.8, {strokeDashoffset: "435px", strokeDasharray: "620px 240px", ease: Power0.easeNone})
        .to(path_plain_word, 1, {strokeDashoffset: "491px", strokeDasharray: "13px, 69, 80px, 650px", ease: Power0.easeNone}, "-=0.8")

        .to(path_gradient_word, 0.4, {strokeDashoffset: "535px", strokeDasharray: "620px 105px", ease: Power0.easeNone})
        .to(path_plain_word, 0.5, {strokeDashoffset: "488px", strokeDasharray: "13px, 69, 0px, 650px", ease: Power0.easeNone}, "-=0.6")

        .to(path_gradient_word, 0.4, {strokeDashoffset: "617px", strokeDasharray: "620px 23px", ease: Power0.easeNone})
        .to(path_plain_word, 0.3, {strokeDashoffset: "500px", strokeDasharray: "0px, 90, 0px, 650px", ease: Power0.easeNone}, "-=0.6")

        .to(path_gradient_word, 0.4, {strokeDashoffset: "654px", strokeDasharray: "620px, 0px", ease: Power0.easeNone}, "-=0.3");
        //virgule

        //.to(path_gradient_word, 1, {strokeDasharray: "534px, 243px"}, "-=1.4")
        //.to(path_gradient_word, 1, {strokeDasharray: "657px, 79px"}, "-=1.4")
        //.to(path_gradient_word, 1, {strokeDasharray: "655px, 0px"}, "-=0.6");

        //stroke-dashoffset: 2195px;
        //stroke-dasharray: 2300px, 92px;

        //.staggerTo(path_plain_word, 2, {strokeDashoffset: "612px", ease: Power1.easeInOut}, 1);
